        ...
        <div className="grid lg:grid-cols-3 gap-6">
                    ...
                    <div className="p-4 bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-300 rounded-xl">
                      <p className="text-slate-800 mb-3">
                        ...
                        <span className="text-slate-600">
                          {" "}
                          | ₹{product.price} | Stock:{" "}
                          {getAvailableStockNumber(product.id, product.quantity)}
                        </span>
                      </p>
                ...
                {customerStatus === "found" && customer && (
                  ...
                  >
                    ...
                    <p className="text-slate-800">
                      Customer: <b className="text-lg">{customer.name}</b>{" "}
                      <span className="text-slate-600">({customer.mobile})</span>
                    </p>
                  </motion.div>
                )}
                ...
                {customerStatus === "not_found" && (
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      ...
                      />
                      <input
                        className="w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-orange-400 transition-all"
                        placeholder="Address"
                        value={customerForm.address}
                        onChange={(e) =>
                          setCustomerForm({
          ...
          >
            <div className="bg-white/90 backdrop-blur-lg rounded-2xl p-6 border border-slate-200 shadow-xl sticky top-6">
              ...
              {/* BILL ITEMS TABLE */}
              <div className="mb-6 overflow-x-auto max-h-64">
                <table className="w-full text-slate-800 border-collapse">
                  <thead className="sticky top-0 bg-white">
                    <tr className="border-b border-slate-200">
                      <th className="text-left py-3 px-2 text-slate-600 font-semibold text-sm">
                        Product
                      </th>
                      <th className="text-right py-3 px-2 text-slate-600 font-semibold text-sm">
                        Price
                      </th>
                      <th className="text-center py-3 px-2 text-slate-600 font-semibold text-sm">
                        Qty
                      </th>
                      <th className="text-right py-3 px-2 text-slate-600 font-semibold text-sm">
                        Total
                          ...
                          <td className="text-center py-3 px-2">
                            <div className="flex items-center justify-center gap-1">
                              <motion.button
                                ...
                                className="p-1 bg-red-100 rounded-lg hover:bg-red-200 transition-all"
                              >
                              ...
                              <motion.button
                                ...
                                className="p-1 bg-green-100 rounded-lg hover:bg-green-200 transition-all"
                              >
                                <Plus className="w-3 h-3 text-green-600" />
                              </motion.button>
                            </div>
                          </td>
                          <td className="text-right py-3 px-2 font-semibold text-xs">
                            ₹{i.total.toFixed(2)}
                          </td>
              ...
              {billItems.length > 0 && (
                <div className="mb-4 p-3 bg-amber-50 border border-amber-200 rounded-xl">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-white border border-amber-300 rounded-lg text-slate-800 focus:outline-none focus:ring-2 focus:ring-amber-500 transition-all"
                    placeholder="0.00"
                  />
                </div>
              )}
              ...
              {/* TOTALS */}
              <div className="space-y-2 p-4 bg-slate-50 rounded-xl border border-slate-200 mb-4">
                ...
                {totals.cash_discount > 0 && (
                  <div className="flex justify-between text-amber-600 text-sm">
                    ...
                    <span className="font-semibold">
                      - ₹{totals.cash_discount.toFixed(2)}
                    </span>
                  </div>
                )}
                ...
                <div className="mb-4 p-3 bg-purple-50 border border-purple-200 rounded-xl">
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                      ...
                      className="w-5 h-5 rounded border-purple-300 text-purple-600 focus:ring-2 focus:ring-purple-500 cursor-pointer"
                    />
                    <div className="flex items-center gap-2">
                      <Printer className="w-4 h-4 text-purple-600" />
                      <span className="text-sm font-semibold text-slate-700">
                        Print bill after generation
                      </span>
                    </div>
                  </label>
                </div>
